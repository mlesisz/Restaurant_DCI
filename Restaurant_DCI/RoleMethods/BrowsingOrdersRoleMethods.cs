...
namespace Restaurant_DCI.RoleMethods
{
    ...
    public static class BrowsingOrdersRoleMethods 
    { 
        public static List<Order> FindOrders(this BrowsingOrdersContex.IOrder order, 
            BrowsingOrdersContex.IChef chef, BrowsingOrdersContex.IClient client, DB_Entities _db)
        {
        ...
        public static Order FindOrder(this BrowsingOrdersContex.IOrder order, DB_Entities _db)
        {
            Order order_ = order as Order;
            bool isReady = true; 
            if(order_ != null)
